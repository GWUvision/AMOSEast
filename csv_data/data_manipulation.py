...
for root, dirs, files in os.walk('../flaskapp/static/images4/images'):
...
for root, dirs, files in os.walk('../flaskapp/static/images4/images'):
    ...
    if(path[size] == 'images'):
        ...
        #print(path[size])
        os.rename(cwd + '/.../flaskapp/static/images4/images/' + path[size], cwd + '/../flaskapp/static/images4/images/a' + path[size])
    ...
    if(path[size] == 'images'):
        ...
        for i in range(0, len(data['cameraid'])):
            if(d == str(data['cameraid'][i])):
                ...
                os.rename(cwd + '/../flaskapp/static/images4/images/' + path[size], cwd + '/../flaskapp/static/images4/images/' + final)
