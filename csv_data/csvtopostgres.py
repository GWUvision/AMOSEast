...
cur = database.cursor()
root = '/home/suraj/Documents/GWU/AMOSEast/csv_data/data2.csv'
...
try:
    sql = "COPY cameras(cameraid, name, url, latitude, longitude, last_width, last_height, mhash) FROM '%s' DELIMITER ',' CSV HEADER" % (root)
    cur.execute(sql)
